            ...
            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="{{url('insertNoteEtudiant')}}" id="loginForm" name="frs" method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label for="sel1">Matricule</label>
                                    <input type="text" class="form-control" value="" name="matricule" >
                                </div>

                                <div class="form-group col-lg-6">
                                    <label for="sel1">Annee Academique</label>
                                    <select class="form-control" id="sel1" name="anneacademiques">
                                        @foreach($anneacademiques as $an)
